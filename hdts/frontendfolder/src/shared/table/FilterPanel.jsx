...
const FILTER_PRESETS = {
  ...
  ticketManagement: {
    ...
    categoryOptions: [
      { label: "IT Support", category: "IT" },
      { label: "Hardware", category: "IT" },
      { label: "Software", category: "IT" },
      { label: "Network", category: "IT" },
      { label: "Asset Check In", category: "Asset" },
      { label: "Asset Check Out", category: "Asset" },
      { label: "Asset Request", category: "Asset" },
      { label: "Asset Registration", category: "Asset" },
      { label: "Asset Repair", category: "Asset" },
      { label: "Asset Incident", category: "Asset" },
      { label: "Asset Disposal", category: "Asset" },
      { label: "New Budget Proposal", category: "Budget" },
      { label: "Account", category: "Access" },
      { label: "General Request", category: "General" },
    ...
    subCategoryOptions: [
      ...
      // Asset Request sub-categories
      { label: "New Asset", category: "Asset Request" },
      { label: "Asset Renewal", category: "Asset Request" },
      // Asset Repair sub-categories
      { label: "Corrective Repair", category: "Asset Repair" },
      { label: "Preventive Maintenance", category: "Asset Repair" },
      { label: "Upgrade", category: "Asset Repair" },
      { label: "Part Replacement", category: "Asset Repair" },
      { label: "OS Re-imaging", category: "Asset Repair" },
      { label: "Warranty Service", category: "Asset Repair" },
      // Asset Incident sub-categories
      { label: "Stolen", category: "Asset Incident" },
      { label: "Damage", category: "Asset Incident" },
      { label: "Employee Resign", category: "Asset Incident" },
    ],
    slaStatusOptions: [
