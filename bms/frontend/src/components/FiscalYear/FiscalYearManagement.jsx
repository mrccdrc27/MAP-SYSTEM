...
const FiscalYearManagement = ({ summaryData }) => {
  ...
  // MODIFICATION START: Added Loading State
  ...
  const fetchFiscalYearsList = async () => {
    // MODIFICATION START: Handle Loading
    setLoading(true);
    try {
  ...
  // --- HANDLERS ---
  // ... (Keep existing handlers: handleCreateFiscalYear, confirmStatusChange, etc.) ...
    ...
    <div className="fy-container">
      ...
      <div className="fy-header">
        ...
        <p className="fy-description">
          Manage fiscal years, view status overview, and perform year-end
          processing.
        </p>
      </div>

      {/* MODIFICATION START: Loading State Check */}
      ...
      {loading ? (
        ...
        <div className="active-year-section">
          {/* ... (Keep existing Active Year Card content) ... */}
          ...
          <div className="fy-stats-grid">
            <div className="fy-stat-card">
              <div>
                ...
                >
                  <span className="fy-stat-value-large">
            ...
            <div className="fy-stat-card">
              ...
              <div className="fy-card-footer">For {currentActiveYear.name}</div>
            </div>
            <div className="fy-stat-card">
              <div>
                <div className="fy-progress-header">
                  <h4 className="fy-stat-label" style={{ marginBottom: 0 }}>
                    Year Progress
                  </h4>
                  <span
                    style={{
        ...
        >
          <strong>Notice:</strong> No fiscal year is currently active. Please
          set a year to "Open".
        </div>
      )}
      {/* MODIFICATION END */}
          ...
          <tbody>
            {loading ? (
              ...
              fiscalYears.map((fy) => (
                <tr
                  key={fy.id}
                  className={fy.is_current ? "fy-row-current" : ""}
                >
        ...
        <div className="modal-overlay">
          <div className="modal-content-small">
            ...
            <div className="modal-actions">
              ...
              <button className="btn-confirm" onClick={handleCreateFiscalYear}>
                Create Fiscal Year
              </button>
            </div>
          </div>
        ...
        <div className="modal-overlay">
          <div className="modal-content-small" style={{ width: "400px" }}>
            ...
            <p style={{ marginBottom: "25px", color: "#495057" }}>
              Are you sure you want to {confirmAction.toLowerCase()} fiscal year
