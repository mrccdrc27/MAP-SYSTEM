...
export default function OverdueAuditFilterModal({ isOpen, onClose, onApplyFilter, initialFilters = {} }) {
      ...
      <div className="modal-container asset-filter-modal-container" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body asset-filter-modal-body">
          <div className="filter-grid">
            ...
            {/* Overdue By */}
            <fieldset>
              <label htmlFor="overdueBy">Overdue By (days)</label>
              <input
                type="number"
                id="overdueBy"
                placeholder="Enter number of days"
                value={filters.overdueBy}
                onChange={(e) => handleInputChange("overdueBy", e.target.value)}
              />
            </fieldset>
